  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="tambah_data_drpp.php">
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h3 class="mb-0"><i class="fa-solid fa-user-plus me-2"></i>Formulir Input Data Hakim Perikanan</h3>
                </div>
                <div class="card-body">
                    <?php
                        // --- Proses simpan data ---
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            if ($stmt->execute()) {
                                header("Location: drp_perikanan.php?status=sukses"); exit();
                            } else {
                                $pesan = '<div class="alert alert-danger">Error: ' . $stmt->error . '</div>';
                            }
                    ...
                    <form action="tambah_data_drpp.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="gol_rg" class="form-label">Golongan / Ruang</label>
                                <input type="text" class="form-control" id="gol_rg" name="gol_rg">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            <label for="asal_organisasi" class="form-label">Asal Organisasi</label>
                            <textarea class="form-control" id="asal_organisasi" name="asal_organisasi" rows="2"></textarea>
                        </div>
                        <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="pendidikan" name="pendidikan" rows="2"></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="kontak" class="form-label">Kontak (Email/Telepon)</label>
                            <input type="text" class="form-control" id="kontak" name="kontak">
                        </div>
                        <div class="mb-3">
                            <label for="riwayat_pekerjaan" class="form-label">Riwayat Pekerjaan</label>
                            <textarea class="form-control" id="riwayat_pekerjaan" name="riwayat_pekerjaan" rows="3"></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="drp_perikanan.php" class="btn btn-secondary">
